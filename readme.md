<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/215337829/21.2.2%2B)
...
The example shows how to integrate the Web Dashboard to your ASP.NET Core application that targets .NET 5.
